      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-8 items-center">
        <div className="text-center md:text-left space-y-6 animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground max-w-xl">
            Building scalable, resilient cloud infrastructure with 6+ years of experience. 
            MSc student passionate about AWS, Terraform, and containerization.
          </p>
        ...
        <div className="hidden md:block">
          <div className="relative">
            ...
            <div className="relative bg-card rounded-full overflow-hidden border border-border aspect-square">
              <img 
                src="https://images.unsplash.com/photo-1546146830-2cca9512c757?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80" 
                alt="Cloud Engineer" 
